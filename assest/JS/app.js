...
/* <div class="flex items-center mt-4">
            <img width="52px" src="./assest/images/Facebook_Logo.png" alt="logo">
            <div class="ml-4">
              <p class="text-lg font-medium">Shahrukh</p>
              <div class="privacy">
        ...
        <div class="text-start pl-24 pt-4 pb-4">print text here</div> */
